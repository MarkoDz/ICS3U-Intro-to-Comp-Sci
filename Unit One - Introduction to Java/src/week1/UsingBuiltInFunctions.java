...
public class UsingBuiltInFunctions {
    ...
    private static void exampleTwo() {
        ...
        System.out.println(randomNumber);   // ex: 0.5852015005024744

        // Goal is to get a random number between 1 and 10
        //for(int i = 0; i<100; i++){
       //     randomNumber = Math.random() * 10;      // multiplies every possible number by 10
        //    System.out.println(randomNumber);       // smallest is 0.0 * 10 = 0.0
       // }                                           // largest is 0.9999999 * 10 = 9.999999999

        for(int i = 0; i<100; i++){
            int randomNumber2 = (int)Math.random() * 10;      // multiplies every possible number by 10 and casts as an int
